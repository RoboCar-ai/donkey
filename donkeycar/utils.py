...
def get_model_by_type(model_type, cfg):
    from donkeycar.parts.keras import KerasRNN_LSTM, KerasBehavioral, KerasCategorical, KerasIMU, KerasLinear, KerasLinearDeepFc, KerasAppInceptionV3, Keras3D_CNN, KerasLocalizer, KerasLinearLoc
    ...
    elif model_type == "linear-loc":
        kl = KerasLinearLoc(input_shape=input_shape)
    elif model_type == "linear-inception":
        kl = KerasAppInceptionV3(input_shape=input_shape)
    elif model_type == "3d":
